-- =========================================
-- SISTEMA DE MONITOREO DE FACTURACIÓN CON IA
-- DDL COMPLETO EN TERCERA FORMA NORMAL (3FN)
-- =========================================
...
CREATE TABLE IF NOT EXISTS usuario (
    ...
    rol VARCHAR(50) NOT NULL DEFAULT 'Contador', -- Administrador, Contador, Auditor
...
CREATE TABLE IF NOT EXISTS factura (
    ...
    fecha DATE NOT NULL,
    estado VARCHAR(30) NOT NULL, -- Emitida, Pagada, Anulada
...
-- =========================================
-- TABLAS DE INTELIGENCIA ARTIFICIAL (IA)
-- =========================================
